...
public class ExcelWriteTest {
    ...
    private static final List<Map<String,Object>> mapList = new ArrayList<Map<String,Object>>() {
        {
            ...
            map1.put("datePublication",Date.from(LocalDate.of(2018,9,9).atStartOfDay(DateUtil.CHINA_ZONE_ID).toInstant()));
            ...
            map2.put("datePublication",Date.from(LocalDate.of(2018,12,9).atStartOfDay(DateUtil.CHINA_ZONE_ID).toInstant()));
    ...
    public void expByObj(){
        ...
        ExcelWriteUtil.toXlsxByObj(objList,headerNames,cellNames,cellFmts);
        //不设置单元格格式，所有所有导出数据均为字符串格式
        //ExcelWriteUtil.toXlsxByObj(objList,headerNames,cellNames);
    }
    ...
    public void expByMap(){
        ...
        ExcelWriteUtil.toXlsxByMap(mapList,headerNames,cellNames,cellFmts);
        //不设置单元格格式，所有所有导出数据均为字符串格式
        //ExcelWriteUtil.toXlsxByMap(mapList,headerNames,cellNames,cellFmts);
    }
}
